            ...
            <div class="container px-4 pb-24 mx-auto">
                ...
                <div class="flex flex-wrap -m-4 text-center">
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div class="border shadow-lg border-gray-200 px-4 py-6 rounded-lg">
                            <img src={customer} alt="" className='mx-auto'/>
                            <h2 class="title-font font-medium text-3xl text-gray-900 ml-2 mt-2">2.7K +</h2>
                            <p class="leading-relaxed text-xl">Happy Customers</p>
                        </div>
                    </div>
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div class="border shadow-lg border-gray-200 px-4 py-6 rounded-lg">
                            <img src={globe} alt="" className='mx-auto'/>
                            <h2 class="title-font font-medium text-3xl text-gray-900 ml-2 mt-2">230 +</h2>
                            <p class="leading-relaxed text-xl">Countries</p>
                        </div>
                    </div>
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div class="border shadow-lg border-gray-200 px-4 py-6 rounded-lg">
                            <img src={orders} alt="" className='mx-auto' />
                            <h2 class="title-font font-medium text-3xl text-gray-900 ml-2 mt-2">20 M +</h2>
                            <p class="leading-relaxed text-xl">Completed Orders</p>
                        </div>
                    </div>
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div class="border shadow-lg border-gray-200 px-4 py-6 rounded-lg">
                            <img src={award} alt="" className='mx-auto' />
                            <h2 class="title-font font-medium text-3xl text-gray-900 ml-2 mt-2">300 +</h2>
                            <p class="leading-relaxed text-xl">Awards</p>
                        </div>
                    </div>
